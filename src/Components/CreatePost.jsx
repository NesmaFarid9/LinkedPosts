...
export default function CreatePost({ callback }) {
    ...
    return <>
        {/* <div className="container mx-auto w-[300px] sm:w-[400px] lg:w-full bg-amber-500"> */}
            <div className="bg-white relative rounded-md shadow-md h-auto py-3 px-3 my-5 bg-gradient-to-br from-blue-50 via-white to-blue-100">
